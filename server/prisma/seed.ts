...
async function main() {
  ...
  const charts = [
    ...
    {
      chart_code: 'CHANNEL_MIX', chart_name: 'Channel Mix & Marketplace Contribution', chart_type: 'doughnut', chart_category: 'composition', default_size: 6, default_order: 4,
      fields: [chartField('sales_channel', 'label'), chartField('sales_amount', 'y')],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'PARETO', chart_name: 'Revenue Concentration Analysis (Pareto)', chart_type: 'bar', chart_category: 'comparison', default_size: 12, default_order: 5,
      fields: [chartField('product_name', 'x'), chartField('sales_amount', 'y')],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'PEAK_HOURS', chart_name: 'Peak Hour Revenue Pattern', chart_type: 'bar', chart_category: 'distribution', default_size: 12, default_order: 6,
      fields: [chartField('transaction_time', 'x'), chartField('sales_amount', 'y'), chartField('transaction_id', 'label', false)],
      formulas: ['TOTAL_REVENUE', 'TOTAL_TRANSACTIONS'],
    },
    {
      chart_code: 'WEEKDAY_SALES', chart_name: 'Revenue by Day of Week', chart_type: 'bar', chart_category: 'distribution', default_size: 4, default_order: 7,
      fields: [chartField('transaction_date', 'x'), chartField('sales_amount', 'y')],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'PAYMENT_MIX', chart_name: 'Payment Method Mix', chart_type: 'doughnut', chart_category: 'composition', default_size: 4, default_order: 8,
      fields: [chartField('payment_method', 'label'), chartField('sales_amount', 'y')],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'BRANCH_PERF', chart_name: 'Branch / Outlet Performance Analysis', chart_type: 'bar', chart_category: 'comparison', default_size: 6, default_order: 9,
      fields: [chartField('branch', 'x'), chartField('sales_amount', 'y')],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'STAFF_PERF', chart_name: 'Staff Revenue Contribution', chart_type: 'bar', chart_category: 'comparison', default_size: 6, default_order: 10,
      fields: [chartField('staff_name', 'x'), chartField('sales_amount', 'y'), chartField('staff_commission', 'filter', false)],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'PRODUCT_MATRIX', chart_name: 'Product Portfolio Matrix (Volume vs Margin)', chart_type: 'scatter', chart_category: 'distribution', default_size: 12, default_order: 11,
      fields: [chartField('product_name', 'label'), chartField('quantity', 'x'), chartField('gross_profit', 'y', false), chartField('cogs', 'y', false), chartField('sales_amount', 'size')],
      formulas: ['TOTAL_REVENUE', 'PROFIT_MARGIN'],
    },
    {
      chart_code: 'DATA_TABLE', chart_name: 'Product Performance Detail Table', chart_type: 'table', chart_category: 'comparison', default_size: 12, default_order: 12,
      fields: [chartField('product_name', 'label'), chartField('sales_amount', 'y'), chartField('quantity', 'size', false), chartField('gross_profit', 'y', false)],
      formulas: ['TOTAL_REVENUE', 'PROFIT_MARGIN'],
    },
    {
      chart_code: 'CATEGORY_BRANCH', chart_name: 'Category Performance by Branch', chart_type: 'bar', chart_category: 'comparison', default_size: 6, default_order: 13,
      fields: [chartField('branch', 'x'), chartField('category', 'color'), chartField('sales_amount', 'y')],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'TIME_CATEGORY', chart_name: 'Hourly Category Demand Pattern', chart_type: 'bar', chart_category: 'distribution', default_size: 6, default_order: 14,
      fields: [chartField('transaction_time', 'x'), chartField('category', 'color'), chartField('sales_amount', 'y')],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'DISCOUNT_EFFECTIVENESS', chart_name: 'Discount Effectiveness Analysis', chart_type: 'scatter', chart_category: 'distribution', default_size: 6, default_order: 15,
      fields: [chartField('product_name', 'label'), chartField('discount_amount', 'x'), chartField('quantity', 'y'), chartField('sales_amount', 'size')],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'SERVICE_DURATION', chart_name: 'Service Duration Benchmark', chart_type: 'bar', chart_category: 'comparison', default_size: 6, default_order: 16,
      fields: [chartField('product_name', 'x'), chartField('duration_mins', 'y'), chartField('sales_amount', 'size', false)],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'BASKET_SIZE', chart_name: 'Basket Size Distribution', chart_type: 'bar', chart_category: 'distribution', default_size: 4, default_order: 17,
      fields: [chartField('transaction_id', 'label'), chartField('sales_amount', 'y'), chartField('quantity', 'size', false)],
      formulas: ['TOTAL_REVENUE', 'AOV'],
    },
    {
      chart_code: 'CITY_SALES', chart_name: 'Destination City Performance', chart_type: 'bar', chart_category: 'comparison', default_size: 4, default_order: 18,
      fields: [chartField('destination_city', 'x'), chartField('sales_amount', 'y'), chartField('transaction_id', 'label', false)],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'BRAND_SALES', chart_name: 'Brand Revenue Contribution', chart_type: 'bar', chart_category: 'comparison', default_size: 4, default_order: 19,
      fields: [chartField('brand', 'x'), chartField('sales_amount', 'y'), chartField('quantity', 'size', false)],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'SUPPLIER_SALES', chart_name: 'Supplier Revenue Contribution', chart_type: 'bar', chart_category: 'comparison', default_size: 4, default_order: 20,
      fields: [chartField('supplier', 'x'), chartField('sales_amount', 'y'), chartField('quantity', 'size', false)],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'CHANNEL_CATEGORY', chart_name: 'Category Mix per Channel', chart_type: 'bar', chart_category: 'composition', default_size: 6, default_order: 21,
      fields: [chartField('sales_channel', 'x'), chartField('category', 'color'), chartField('sales_amount', 'y')],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'PAYMENT_CHANNEL', chart_name: 'Payment Method per Channel', chart_type: 'bar', chart_category: 'composition', default_size: 6, default_order: 22,
      fields: [chartField('payment_method', 'x'), chartField('sales_channel', 'color'), chartField('sales_amount', 'y')],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'STAFF_CATEGORY', chart_name: 'Staff Performance per Category', chart_type: 'bar', chart_category: 'comparison', default_size: 6, default_order: 23,
      fields: [chartField('staff_name', 'x'), chartField('category', 'color'), chartField('sales_amount', 'y'), chartField('staff_commission', 'filter', false)],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'CHANNEL_EFFICIENCY', chart_name: 'Channel Efficiency: AOV & Discount Rate', chart_type: 'bar', chart_category: 'comparison', default_size: 6, default_order: 24,
      fields: [chartField('sales_channel', 'x'), chartField('sales_amount', 'y'), chartField('transaction_id', 'label'), chartField('discount_amount', 'filter', false)],
      formulas: ['TOTAL_REVENUE', 'AOV'],
    },
    {
      chart_code: 'CATEGORY_PROFITABILITY', chart_name: 'Category Profitability Index', chart_type: 'bar', chart_category: 'comparison', default_size: 6, default_order: 25,
      fields: [chartField('category', 'x'), chartField('sales_amount', 'y'), chartField('gross_profit', 'y', false), chartField('cogs', 'filter', false), chartField('transaction_id', 'label', false)],
      formulas: ['TOTAL_REVENUE', 'PROFIT_MARGIN', 'AOV'],
    },
    {
      chart_code: 'PROMO_CAMPAIGN', chart_name: 'Promo Campaign Performance', chart_type: 'bar', chart_category: 'comparison', default_size: 6, default_order: 26,
      fields: [chartField('promo_code', 'x'), chartField('sales_amount', 'y'), chartField('transaction_id', 'label', false)],
      formulas: ['TOTAL_REVENUE', 'TOTAL_TRANSACTIONS'],
    },
    {
      chart_code: 'CUSTOMER_SEGMENT', chart_name: 'Customer Segment Mix', chart_type: 'doughnut', chart_category: 'composition', default_size: 6, default_order: 27,
      fields: [chartField('customer_type', 'label'), chartField('sales_amount', 'y')],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'VARIANT_POPULARITY', chart_name: 'Product Variant Popularity', chart_type: 'bar', chart_category: 'comparison', default_size: 6, default_order: 28,
      fields: [chartField('variant', 'x'), chartField('quantity', 'y')],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'ORDER_FULFILLMENT', chart_name: 'Order Status Fulfillment', chart_type: 'doughnut', chart_category: 'composition', default_size: 6, default_order: 29,
      fields: [chartField('payment_status', 'label'), chartField('transaction_id', 'y')],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'ORDER_TYPE_MIX', chart_name: 'Order Type Contribution', chart_type: 'doughnut', chart_category: 'composition', default_size: 6, default_order: 30,
      fields: [chartField('order_type', 'label'), chartField('sales_amount', 'y')],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'PAYMENT_PROVIDER_SHARE', chart_name: 'Payment Provider breakdown', chart_type: 'bar', chart_category: 'composition', default_size: 6, default_order: 31,
      fields: [chartField('payment_method', 'x'), chartField('payment_provider', 'color'), chartField('sales_amount', 'y')],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'COURIER_EFFICIENCY', chart_name: 'Courier Revenue vs Fees', chart_type: 'bar', chart_category: 'comparison', default_size: 6, default_order: 32,
    ...
    {
      chart_code: 'TABLE_REVENUE', chart_name: 'Dine-In Table Productivity', chart_type: 'bar', chart_category: 'comparison', default_size: 6, default_order: 33,
      fields: [chartField('table_number', 'x'), chartField('sales_amount', 'y')],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'PROMO_ROI', chart_name: 'Promo Cost vs Net Revenue', chart_type: 'bar', chart_category: 'comparison', default_size: 6, default_order: 34,
    ...
    {
      chart_code: 'CUSTOMER_LOYALTY_MIX', chart_name: 'Membership Category Mix', chart_type: 'bar', chart_category: 'composition', default_size: 6, default_order: 35,
      fields: [chartField('customer_type', 'x'), chartField('category', 'color'), chartField('sales_amount', 'y')],
      formulas: ['TOTAL_REVENUE'],
    },
    {
      chart_code: 'VARIANT_PROFITABILITY', chart_name: 'Variant Margin vs Volume Matrix', chart_type: 'scatter', chart_category: 'distribution', default_size: 6, default_order: 36,
